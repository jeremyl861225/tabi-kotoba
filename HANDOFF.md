...
| 視覺 | **米白底 #f7f5f0**（2026-09-25；米色、純白都試過）＋暖咖啡深色模式；**一個主題家族一個顏色**（Colormind 色票主色），當點綴（線、站點、按鈕）與下一站卡片的淡彩（12%）；首頁主題家族格是白色細框；日文明朝、中文宋體（系統字）；首頁路線圖；不放插圖、不要幼稚感、不要慢動畫。詳見 skill 的 design.md 與本 repo 的 PRODUCT.md |
...
- [x] 2026-09-25：使用者在測試 repo（`tabi-kotoba-test`）選了第 6 種「下一站淡彩＋白色細框色塊」，並要求底色不要那麼白 → `#f7f5f0`；
